...
- Быстрое подключение за <3-8 сек. (Оригинал: >15-20сек.) с множества устройств, даже из одной Wi-Fi сети 
...
# Как работает:
-iOS отдельно	
--У iOS в отличие от Android и Desktop разные паттерны подключений. В одном лимите они мешают друг другу. Разделение на порты конечно решение, но костыльное. Наш же фикс производит разделение этих клиентов по TTL
