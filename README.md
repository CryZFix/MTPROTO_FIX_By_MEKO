...
**Помогает решить в 1 клик проблему**, которая появилась с 4 июня, **когда telegram клиент не может подключиться к mtproto прокси-серверу**. 
...
```
2. **Установить стандартный Telemt** версии 3.4.22 или 3.4.18 и ниже, также **альтернативой** вы можете поставить "**MTPROTO.zig**" (все прокси можно поставить через меню нашего скрипта, ставить их заранее на сервер не обязательно)
3. Выполнить установку нашего фикса снова нажав 1.
