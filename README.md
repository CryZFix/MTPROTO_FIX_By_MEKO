...
<p align="center">
  · <a href="#Быстрый-старт">Установка в 1 клик</a> · <a href="#Как-работает-фикс">FAQ</a> · <a href="#Возможные-проблемыпочему-у-меня-может-не-работать">Решение проблем</a> · <a href="#⭐-Поддержать-проект">Donate</a> ·
</p>
...
4. Применить наш фикс к прокси нажав **1** в главном меню
5. **Отключить встроенные MSS и SYN** из конфига телемт нажав **2** (если он уже был добавлен в конфиг телемт на сервер ранее)
6. Готово.
...
- Наиболее полезное, простое и рабочее решение в 99% случаев, если у клиента, с которого не работает прокси не старый айфон, это:
  - Переустановить ОС, поставить чистый телемт 3.4.22 и наш фикс.
